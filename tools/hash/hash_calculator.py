#!/usr/bin/env python3
"""
Hash Calculator for OpenLinkToken Secrets

This script calculates secure SHA-256 hashes for encryption and hashing secrets
used in the OpenLinkToken processing flow. The hashes produced by this script
...
file generated by the OpenLinkToken Java application.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="hash_calculator.py", description="Calculate secure SHA-256 hashes for OpenLinkToken secrets"
    )
    ...
    if args.output_format == "json":
        ...
        print("OpenLinkToken Secret Hashes")
        print("=" * 50)
        for key, value in results.items():
            print(f"{key:20}: {value}")
        print("=" * 50)
        print("These hashes match those generated by the Java OpenLinkToken application")
