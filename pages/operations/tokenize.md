...
**Solution:** Verify both runs used the same exchange config and hashing secret source. When metadata includes `HashingSecretHash`, identical hashes confirm that both runs used the same secret:
