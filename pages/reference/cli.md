...
| `--output`          | `-o`  | No       | `<input_basename>_packaged.zip`               | Path to output file. Supported extensions: `.csv`, `.parquet`, `.zip`. A `.zip` path bundles the tokens, metadata, and exchange config into one archive. |
