...
| `--config`                                                 |       | No       |                                             | YAML config file for custom input field mapping and token-rule definitions. Supported for CSV and Parquet input.                                                                    |
...
| `--disable-ml1`                                            |       | No       | ML1 enabled                                 | Disable ML1 ONNX inference token generation.                                                                                                                                        |
| `--ml1-model-path`                                         |       | No       | `classpath:/inferencing/ml1/model.onnx`     | Path to the ML1 ONNX model.                                                                                                                                                         |
| `--ml1-tokenizer-path`                                     |       | No       | `classpath:/inferencing/ml1/tokenizer.json` | Path to the ML1 tokenizer JSON.                                                                                                                                                     |
| `--ml1-max-seq-length` (alias `--ml1-max-sequence-length`) |       | No       | `128`                                       | Maximum ML1 tokenizer sequence length.                                                                                                                                              |
| `--ml1-batch-size`                                         |       | No       | `64`                                        | ML1 ONNX inference batch size.                                                                                                                                                      |
| `--ml1-num-threads`                                        |       | No       | `0` (auto-detect)                           | ONNX Runtime intra/inter-op thread count for ML1 inference.                                                                                                                         |
| `--rotation-iv`                                            |       | No       | Exchange config value                       | Override the rotation IV used for ML1 token generation.                                                                                                                             |
...
| `--rotation-iv`                                            |       | No                |                                             | Override the rotation IV used for ML1 token generation.                                                                                                                                                                        |
| `--no-progress`                                            | `-q`  | No                |                                             | Suppress the interactive progress indicator.                                                                                                                                                                                   |
