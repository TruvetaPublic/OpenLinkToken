...
| `-c`                | `--exchange-config` | No       | Exchange config JSON path. Defaults to `./openlinktoken-YYYY-MM-DD.exchange.json` when omitted. |
...
| `--input`           | `-i`                | Yes               | Path to input file (CSV or Parquet)                                                                                                                                                                                            |
| `--output`          | `-o`                | Yes               | Path to output file                                                                                                                                                                                                            |
| `-c`                | `--exchange-config` | Default mode only | Exchange config JSON path. Defaults to `./openlinktoken-YYYY-MM-DD.exchange.json` when omitted.                                                                                                                                |
