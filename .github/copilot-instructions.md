...
- **OpenToken architecture and parity:** `.github/instructions/opentoken-architecture.instructions.md`
...
- For OpenToken component layout, registration patterns, and parity-sensitive changes, use `.github/instructions/opentoken-architecture.instructions.md`.
