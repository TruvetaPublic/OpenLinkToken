...
OpenToken is a dual-implementation library. Java and Python should produce equivalent behavior and byte-identical token outputs for the same normalized input unless a change is explicitly designed otherwise.
...
- **Java:** add the implementation to the appropriate `META-INF/services/com.truveta.opentoken...` ServiceLoader file
